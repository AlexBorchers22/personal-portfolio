      ...
      <div>
        <footer className="footer">
          <div className="footer-widget">
            <a href='https://github.com/Alex-Borchers-22' target='_blank'>
            ...
            <a href='https://www.linkedin.com/in/alex-borchers-7597b8152/' target='_blank'>
            ...
            <a href='https://twitter.com/BOOOOORCH' target='_blank'>
